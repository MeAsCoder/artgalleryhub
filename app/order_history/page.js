...
const OrderHistory = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto p-6">
            <h1 className="text-2xl font-bold mb-6 text-center text-rose-400">Order History</h1>
            <p className="mb-4 text-center">Check the status of recent orders, manage returns, and download invoices.</p>
